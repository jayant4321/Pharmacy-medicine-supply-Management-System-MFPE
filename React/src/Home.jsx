...
function Home() {
  ...
  <div className="mainDiv">
      <h1 style={{color:"#A7685A"}} data-testid="rooot"><b><u><i>Welcome to Pharamacy Medicine Supply Management</i></u> </b></h1>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt" style={{color:"#5946B1"}}>100% Genuine Medicine</Card.Title>
      <Card.Text>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt1" style={{color:"#364E2B"}}>Most Trusted Online Medical Store Of India</Card.Title>
      <Card.Text>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt2" style={{color:"#5946B1"}}>Fastest Home Delivery Of Your Order</Card.Title>
      <Card.Text>
...
<CardGroup>
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt3" style={{color:"#364E2B"}}>Largest Online Pharmacy In India</Card.Title>
      <Card.Text>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt4" style={{color:"#5946B1"}}>Best Pharmacologist Available To Check Medicine Interactions</Card.Title>
      <Card.Text>
  ...
  <Card>
    ...
    <Card.Body>
      <Card.Title data-testid="rt5" style={{color:"#364E2B"}}>Additional Services I Will Receive</Card.Title>
      <Card.Text>
