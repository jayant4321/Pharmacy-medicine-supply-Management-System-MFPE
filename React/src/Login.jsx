...
function Login() {
    ...
    return (
        ...
        <div className="centerDiv">
          <h1 style={{color:"#A7685A"}}><b><LoginIcon className="header_logo" fontSize="large" />Log-in</b></h1>
          <form onSubmit={login}>
            <TextField 
              fullWidth
              label="username"
            ...
            <Button id="button" type="submit" variant="outlined" color="inherit" size="large">
