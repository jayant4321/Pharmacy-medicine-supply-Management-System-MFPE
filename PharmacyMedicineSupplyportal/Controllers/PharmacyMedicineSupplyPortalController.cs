...
namespace PharmacyMedicineSupplyportal.Controllers
{
    ...
    public class PharmacyMedicineSupplyPortalController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] PharmacyMembers userLogin)
        {
            ...
            string BaseUrl= "http://20.241.130.120/api/PharmacyAuth";
        ...
        public IActionResult GetMedicineList()
        {
            ...
            var list = medicineStock.GetMedicineList(token);
            return Ok(list);
        }
        ...
        {
            var token = HttpContext.Request.Headers["Authorization"];
            var repSchedule = representativeSchedule.GetRepSchedule(startDate,token);
        ...
        {
            var token = HttpContext.Request.Headers["Authorization"];
            var medSupply = supply.GetPharmacyMedicinesSupply(med,token);
